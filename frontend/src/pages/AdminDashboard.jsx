...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen p-8 bg-black text-white">
      <h1 className="text-4xl font-bold mb-6 text-center text-[#dc2626]">
        Admin Dashboard
      </h1>
      {message && (
        ...
        <div className="flex justify-around border-b border-gray-700 mb-6">
          <button
            ...
            className={`px-4 py-2 font-semibold transition-all ${
              activeTab === 'pending'
                ? "text-[#dc2626] border-b-4 border-[#dc2626]"
                ...
                >
                  ...
                  <div className="flex gap-2 mt-4 md:mt-0">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#dc2626] text-white rounded-lg hover:bg-[#b91c1c] hover:shadow-[0_6px_20px_rgba(220,38,38,0.5)]"
                    >
                      Reject
                    </button>
                  </div>
              ...
              {rejectedVideos.map(video => (
                ...
                >
                  ...
                  {video.rejectionReason && (
                    <p className="text-[#dc2626] text-sm mt-2">Reason: {video.rejectionReason}</p>
                  )}
                  {video.videoUrl && (
                    <video controls src={video.videoUrl} className="mt-2 w-full max-h-60 object-contain rounded-md"></video>
                  )}
            ...
            <form onSubmit={handleCourseUpload} className="space-y-4 bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full text-sm text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#dc2626] file:text-white hover:file:bg-[#b91c1c]"
                  required
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                className="w-full py-2 rounded-lg bg-[#dc2626] text-white font-semibold hover:bg-[#b91c1c] hover:shadow-[0_8px_30px_rgba(220,38,38,0.5)]"
                ...
                {myUploadedCourses.map(course => (
                  <div key={course._id} className="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      {course.videoUrl && (
                        <a href={course.videoUrl} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block px-3 py-1 bg-[#dc2626] text-white rounded-md text-sm hover:bg-[#b91c1c] hover:shadow-[0_6px_20px_rgba(220,38,38,0.5)]">Watch Video</a>
                      )}
                    </div>
                  </div>
                ))}
                  ...
                  <div key={course._id} className="bg-gray-800 rounded-lg shadow-md p-6">
                    <div className="flex justify-between items-start mb-4">
                          ...
                          {editingCourseFaculty === course._id ? (
                            <div className="flex items-center gap-2">
                              ...
                              <select
                                ...
                                className="px-2 py-1 bg-gray-600 text-white rounded border border-gray-500 focus:outline-none focus:border-[#dc2626] text-sm"
                              >
                      ...
                      <button
                        ...
                        className="ml-4 px-4 py-2 bg-[#dc2626] text-white rounded-lg hover:bg-[#b91c1c] hover:shadow-[0_8px_30px_rgba(220,38,38,0.5)]"
                      >
                                  ...
                                  {editingStudentId === student._id ? (
                                    <>
                                      <input
                                        ...
                                        placeholder="Points"
                                        className="w-24 px-2 py-1 bg-gray-600 text-white rounded border border-gray-500 focus:outline-none focus:border-[#dc2626]"
                                      />
                                      <button
