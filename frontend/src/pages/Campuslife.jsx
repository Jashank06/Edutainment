      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center text-center p-6">
        ...
        <div className="relative z-10">
          ...
          <button
            ...
            className="mt-6 px-6 py-3 bg-[#dc2626] rounded-full flex items-center gap-2 hover:bg-[#dc2626]/90 transition"
          >
          ...
          <div className="mt-12 flex gap-6 flex-wrap justify-center">
            {podcasts.map((p, idx) => (
              <img
                ...
                className="w-60 h-40 object-cover rounded-xl cursor-pointer border-2 border-transparent hover:border-[#dc2626] transition hover:scale-105 hover:shadow-[0_0_15px_rgba(220,38,38,0.7)]"
              />
            ))}
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
          ...
          <div className="flex flex-col items-center gap-4 w-full max-w-5xl">
            ...
            <iframe
              ...
              allowFullScreen
              className="w-full h-[60vh] rounded-lg shadow-[0_0_25px_rgba(220,38,38,0.5)]"
            ></iframe>
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {courses.map((course, idx) => (
            <img
              ...
              className="w-full h-40 object-cover rounded-lg cursor-pointer transition hover:scale-105 hover:shadow-[0_0_15px_rgba(220,38,38,0.7)]"
            />
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {iconsWithVideos.map((icon, idx) => (
            <img
              ...
              className="w-full h-52 object-cover rounded-md cursor-pointer transition hover:scale-105 hover:shadow-[0_0_15px_rgba(220,38,38,0.7)]"
            />
          ))}
        </div>
      </div>
